 ...
 * Method: GET
 *
 * @param {string} assignmentID - The Box ID of the task assignment being requested
 * @param {?Object} qs - Additional options can be passed with the request via querystring.
 * @param {Function} callback - Passed the file information if it was acquired successfully, error otherwise
 * @returns {void}
 */
Tasks.prototype.getAssignment = function(assignmentID, qs, callback) {
