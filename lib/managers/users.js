 ...
 *
 * @param {?Object} qs - Optional additional querystring to add to the request. Can be left null in most cases.
 * @param {Function} callback - Passed the enterprise users info if it was acquired successfully, error otherwise
 * @returns {void}
 */
 ...
 * @param {Function} callback - Passed the invite information if it was acquired successfully, error otherwise
 * @returns {void}
 */
 ...
 * @param {Function} callback - Passed with updated user if successful, error otherwise
 * @returns {void}
 */
