...
/**
 * An resolution states constant. Used for setting and updating shared links, folder upload, etc.
 * @typedef {?Object} ResolutionStates
 */
...
/**
 * Enum of valid values for setting different resolutions states. To be used with task assignments.
 *
 * @readonly
 * @type {String}
 */
BoxClient.prototype.resolutionStates = {
	COMPLETED: 'completed',
